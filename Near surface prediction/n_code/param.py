...
n_path = 'C:/Users/chonglh/Desktop/oxidaton2.0/nearsurface/NS_ml/data/NS_data_n.csv'
n_data = pd.read_csv(n_path, encoding='gb2312')
n_data = n_data[n_data['alloy'] != '32Y3']
data, label = n_data.values[:, 1: -1], n_data['gamapie shape factor'].values
cv_data, _, _, _, _ = split.DataSplit(data, label, 2022).get_split()
params = {}
